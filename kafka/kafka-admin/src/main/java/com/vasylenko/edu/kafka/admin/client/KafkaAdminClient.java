package com.vasylenko.edu.kafka.admin.client;

import com.vasylenko.edu.config.KafkaConfigData;
import com.vasylenko.edu.config.RetryConfigData;
import com.vasylenko.edu.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    public void createTopics() {
        ...
        try {
            ...
            LOGGER.info("Create topics result: {}", createTopicsResult.values().values());
        } catch (Throwable t) {
    ...
    private org.springframework.http.HttpStatusCode getSchemaRegistryStatus() {
        try {
            return webClient
